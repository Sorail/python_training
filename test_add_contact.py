...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contract(self):
        ...
        self.create_contact(wd, Contact(firstname="qazwsx", middlename="edcrfv", lastname="tgbyhn", nickname="yhnujm",
                       ...
                       email3="fdjjfdskl@fjdkjfkds.ru", homepage="gjfdjhgdfjgkl", bday="12", bmonth="April", byear="1980",
